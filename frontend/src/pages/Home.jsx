    ...
    <div className="min-h-screen pb-32 bg-black text-white">
      ...
      <div className="max-w-7xl mx-auto px-10 py-10">
        ...
        <div className="grid grid-cols-2 gap-16 items-center mb-20">
          ...
          <div>
            <p className="text-purple-400 font-semibold tracking-[0.3em] uppercase mb-4">
            ...
            <p className="mt-6 text-xl text-zinc-400 leading-8 max-w-xl">
            ...
            <div className="mt-8">
              ...
              <div className="inline-flex items-center gap-3 mt-3 bg-purple-600/20 border border-purple-500/30 rounded-full px-5 py-3">
          ...
          <Card className="relative overflow-hidden p-6 border border-purple-500/20 bg-gradient-to-br from-zinc-900 to-zinc-950 shadow-2xl shadow-purple-500/10">
        ...
        <div className="mb-10">
          ...
          <h2 className="text-4xl font-bold">Recommended Songs</h2>
