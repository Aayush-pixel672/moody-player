...
const FavoriteSchema = new mongoose.Schema({
    ...
    userId:{
        ...
        ref: 'User', // ye ref hai jiska matlab hai ki ye reference kis collection ka hai, yaha pe humne 'Song' diya hai, iska matlab hai ki ye reference Song collection ka hoga
