...
router.post('/',createSong); // yaha pe hum apne createSong function ko post request ke sath use karenge taki jab bhi koi post request aayegi to wo createSong function ko call karega aur uske andar jo logic hai wo execute hoga
