...
router.post('/',authMiddleware,adminMiddleware,upload.fields([ // matlab authentication check and admin check dono hoga jab upload song ki baari aayegi
