...
router.delete('/:id',deletehistory); // yaha pe hum apne deletehistory function ko delete request ke sath use karenge taki jab bhi koi delete request aayegi to wo deletehistory function ko call karega aur uske andar jo logic hai wo execute hoga

router.delete('/',deleteAllhistory); // yaha pe hum apne deleteAllhistory function ko delete request ke sath use karenge taki jab bhi koi delete request aayegi to wo deleteAllhistory function ko call karega aur uske andar jo logic hai wo execute hoga
