...
router.get('/',getAllFavorites); // yaha pe hum apne getAllFavorites function ko get request ke sath use karenge taki jab bhi koi get request aayegi to wo getAllFavorites function ko call karega aur uske andar jo logic hai wo execute hoga

router.post('/',addFavorite); // yaha pe hum apne addFavorite function ko post request ke sath use karenge taki jab bhi koi post request aayegi to wo addFavorite function ko call karega aur uske andar jo logic hai wo execute hoga

router.delete('/:id',deleteFavorite); // yaha pe hum apne deleteFavorite function ko delete request ke sath use karenge taki jab bhi koi delete request aayegi to wo deleteFavorite function ko call karega aur uske andar jo logic hai wo execute hoga, yaha pe :id ka matlab hai ki ye ek dynamic parameter hai, jab bhi koi request aayegi to usme id aayega aur us id ke basis pe hum favorite ko delete karenge
